...
def _process_frame42(frame, variation,env="breakout"):
    # print(frame.shape)
...
class AtariRescale42x42(gym.ObservationWrapper):
    def __init__(self, env=None, variation=None,env_name="breakout"):
    ...
    def observation(self, observation):
        return _process_frame42(observation, self.variation,self.env_name)
